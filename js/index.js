var $,tab,nav,skyconsWeather;
layui.config({
	base : "js/"
}).use(['bodyTab','form','element','layer','jquery','bodyNav'],function(){
	var form = layui.form(),
		layer = layui.layer,
	...
	// 更新左侧导航栏
	$("body").on("click",".topNav .layui-nav-item .loadChild",function(){
        loadLeftNav($(this).find('cite').text());
	})
...
function loadLeftNav(title){
	nav.loadLeftNav(title);
}
//捐赠弹窗
function donation(){
	layer.tab({
